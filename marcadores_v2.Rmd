...
p_val <-function(x){
  if_else(is.logical(covid_full_4[[x]]),
          ...
          if_else(t.test(covid_full_4$desenlace_uti, covid_full_4[[x]])$p.value<0.001,
                        "<0.001 t test", str_c(round(t.test(covid_full_4$desenlace_uti, covid_full_4[[x]])$p.value,3), " t test")))
  }
